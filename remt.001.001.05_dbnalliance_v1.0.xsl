...
<xsl:stylesheet xmlns:xs="http://www.w3.org/2001/XMLSchema"
   ...
   <!--PATTERN remt.001-005-->
	  ...
	  <!--RULE -->
   <xsl:template match="qdt:Othr" priority="1000" mode="M5">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="qdt:Othr"/>

		    <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="ancestor::qdt:OrgId[parent::qdt:Id[parent::qdt:InitgPty]] and normalize-space(qdt:Id) != ''"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="ancestor::qdt:OrgId[parent::qdt:Id[parent::qdt:InitgPty]] and normalize-space(qdt:Id) != ''">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>
   ...
   <!--PATTERN remt.001-006-->
	  ...
	  <!--RULE -->
   <xsl:template match="qdt:Othr" priority="1000" mode="M6">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="qdt:Othr"/>

		    <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="ancestor::qdt:OrgId[parent::qdt:Id[parent::qdt:MsgRcpt]] and normalize-space(qdt:Id) != ''"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="ancestor::qdt:OrgId[parent::qdt:Id[parent::qdt:MsgRcpt]] and normalize-space(qdt:Id) != ''">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>
   ...
   <!--PATTERN remt.001-016-->
	  ...
	  <!--RULE -->
   <xsl:template match="qdt:Nm" priority="1000" mode="M16">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="qdt:Nm"/>

		    <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="ancestor::qdt:Dbtr[ancestor::qdt:OrgnlPmtInf[ancestor::qdt:RmtInf[ancestor::qdt:RmtAdvc]]]"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="ancestor::qdt:Dbtr[ancestor::qdt:OrgnlPmtInf[ancestor::qdt:RmtInf[ancestor::qdt:RmtAdvc]]]">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>
   ...
   <!--PATTERN remt.001-017-->
	  ...
	  <!--RULE -->
   <xsl:template match="qdt:Nm" priority="1000" mode="M17">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="qdt:Nm"/>

		    <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="ancestor::qdt:Cdtr[ancestor::qdt:OrgnlPmtInf[ancestor::qdt:RmtInf[ancestor::qdt:RmtAdvc]]]"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="ancestor::qdt:Cdtr[ancestor::qdt:OrgnlPmtInf[ancestor::qdt:RmtInf[ancestor::qdt:RmtAdvc]]]">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>
   ...
   <!--PATTERN remt.001-018-->
	  ...
	  <!--RULE -->
   <xsl:template match="qdt:Prtry" priority="1000" mode="M18">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="qdt:Prtry"/>

		    <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="ancestor::qdt:SchmeNm[ancestor::qdt:Othr[ancestor::qdt:OrgId[ancestor::qdt:Id[ancestor::qdt:InitgPty[ancestor::qdt:GrpHdr[ancestor::qdt:RmtAdvc]]]]]] and . = 'exchange framework'"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="ancestor::qdt:SchmeNm[ancestor::qdt:Othr[ancestor::qdt:OrgId[ancestor::qdt:Id[ancestor::qdt:InitgPty[ancestor::qdt:GrpHdr[ancestor::qdt:RmtAdvc]]]]]] and . = 'exchange framework'">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>
   ...
   <!--PATTERN remt.001-019-->
	  ...
	  <!--RULE -->
   <xsl:template match="qdt:Prtry" priority="1000" mode="M19">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="qdt:Prtry"/>

		    <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="ancestor::qdt:SchmeNm[ancestor::qdt:Othr[ancestor::qdt:OrgId[ancestor::qdt:Id[ancestor::qdt:MsgRcpt[ancestor::qdt:GrpHdr[ancestor::qdt:RmtAdvc]]]]]] and . = 'exchange framework'"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="ancestor::qdt:SchmeNm[ancestor::qdt:Othr[ancestor::qdt:OrgId[ancestor::qdt:Id[ancestor::qdt:MsgRcpt[ancestor::qdt:GrpHdr[ancestor::qdt:RmtAdvc]]]]]] and . = 'exchange framework'">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>
   ...
   <!--PATTERN remt.001-020-->
	  ...
	  <!--RULE -->
   <xsl:template match="qdt:Cd" priority="1000" mode="M20">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="qdt:Cd"/>

		    <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="ancestor::qdt:SchmeNm[ancestor::qdt:Othr[ancestor::qdt:OrgId[ancestor::qdt:Id[ancestor::qdt:InitgPty[ancestor::qdt:GrpHdr[ancestor::qdt:RmtAdvc]]]]]] and . = ''"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="ancestor::qdt:SchmeNm[ancestor::qdt:Othr[ancestor::qdt:OrgId[ancestor::qdt:Id[ancestor::qdt:InitgPty[ancestor::qdt:GrpHdr[ancestor::qdt:RmtAdvc]]]]]] and . = ''">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>
   ...
   <!--PATTERN remt.001-021-->
	  ...
	  <!--RULE -->
   <xsl:template match="qdt:Cd" priority="1000" mode="M21">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="qdt:Cd"/>

		    <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="ancestor::qdt:SchmeNm[ancestor::qdt:Othr[ancestor::qdt:OrgId[ancestor::qdt:Id[ancestor::qdt:MsgRcpt[ancestor::qdt:GrpHdr[ancestor::qdt:RmtAdvc]]]]]] and . = ''"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="ancestor::qdt:SchmeNm[ancestor::qdt:Othr[ancestor::qdt:OrgId[ancestor::qdt:Id[ancestor::qdt:MsgRcpt[ancestor::qdt:GrpHdr[ancestor::qdt:RmtAdvc]]]]]] and . = ''">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>
